//@ts-nocheck
export function setWebGlBackground() {
  /*
  ...
  class Gradient {
      ...
      e(this, "el", void 0),
        ...
        e(this, "handleScroll", () => {
          ...
          if (scrolled >= viewportHeight) {
            ...
            // Gradually fade out as we approach viewport height
            this.el.style.opacity = (1 - scrolled / viewportHeight).toString();
          }
        }),
    ...
    async connect() {
      (this.shaderFiles = {
        ...
        fragment:
          "varying vec3 v_color;\n\nvoid main() {\n  vec3 color = v_color;\n  vec2 st = gl_FragCoord.xy/resolution.xy;\n  \n  // Fade to black from bottom to top\n  float fadeToBlack = smoothstep(0.9999, 0.01, st.y); // Inverted the parameters\n  color = mix(color, vec3(0.0), fadeToBlack);\n  \n  if (u_darken_top == 1.0) {\n    color.g -= pow(st.y + sin(-12.0) * st.x, u_shadow_power) * 0.4;\n  }\n  gl_FragColor = vec4(color, 1.0);\n}",
      }),
        (this.conf = {
          presetName: "",
          wireframe: false,
