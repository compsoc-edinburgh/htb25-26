...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6 max-w-md p-5", className)} {...props}>
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col gap-6">
          ...
          <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
            <span className="relative z-10 px-2 bg-white text-zinc-600">
              Or
            </span>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            <Button variant="outline" type="button" className="w-full flex items-center gap-2 text-xs">
      ...
      <div className="text-center text-xs text-balance text-zinc-600 [&_a]:underline [&_a]:underline-offset-4 [&_a]:hover:text-zinc-800">
